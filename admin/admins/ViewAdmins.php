            ...
            <tr>
                ...
                <td class="text-center">
                    <a onclick="if(!confirm('Do you want to edit this field ?'))return false;"
                       href="<?php echo BURL_ADMINS."/admins/edit.php?action=edit&id=".$row['admin_id']?>" class="btn btn-info">Edit</a>

                    <a onclick="if(!confirm('Do you want to delete this field ?'))return false;"
                       href="<?php echo BURL_ADMINS."/admins/delete.php?action=delete&id=".$row['admin_id']?>" class="btn btn-danger delete" >Delete</a>
                </td>
            </tr>
        <?php }?>
        </tbody>
