...
<div class="col-sm-6 offset-sm-3 p-3 bg-dark bg-opacity-75 border border-dark p-5">
    ...
    <h3 class="text-center p-3 bg-info text-white">Add New City</h3>
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div class="form-group">
            <label style="color:white;background: #383d41;font-size: large;font-style: italic" >Name Of City</label>
            <label>
